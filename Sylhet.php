...
<html lang="en">
  ...
  <body>
                             ...
                             <h4 class="adjst">Tour Package Two #2 </h4>
                               <p> 3 person</p>
								<p> 3 days 2 night</p> 
								  <p> By Train</p> 
                                    <p> Hotel Supreme</p>
                              <span class="label label-danger">Cost: 2000 Tk</span>
							     <a href="BookingPage.php" style="background-color:green;color:white;padding:3px">Add</a>
          ...
          <div class="row go-marg">
                   ...
                   <div class="col-md-4 col-sm-4">
                     ...
                     <div class="col-md-4 col-sm-4">
                        ...
                        <div class="panel-body">
                             ...
                             <span class="label label-danger">Cost: 10000  Tk</span>
							  <a href="BookingPage.php" style="background-color:green;color:white;padding:3px">Add</a>
                        </div>
                    </div> 
            ...
            $con=mysqli_connect("localhost" , "root" , "");
              $db=mysqli_select_db($con,'cse_411');
	            $query="SELECT * FROM `images` where name='shylhet' ";
    ...
    <div class="container">
      ...
      <h2 style="text-align: center;">Sylhet View</h2>
	  </br>
          <div class="row">
                <div class="col-md-4">
                  <div class="thumbnail">
