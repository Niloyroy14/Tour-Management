...
$db=mysqli_select_db($con,'cse_411');
	$query="SELECT * FROM `images` where name='rajsahi' ";
    ...
    <div class="container">
      ...
      <h2 style="text-align: center;">Rajsahi View</h2>
	  </br>
          <div class="row">
                <div class="col-md-4">
                  <div class="thumbnail">
