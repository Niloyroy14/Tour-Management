...
<html lang="en">
  ...
  <body>
		...
		<?php
          ...
          $con=mysqli_connect("localhost" , "root" , "");
           $db=mysqli_select_db($con,'cse_411');
	        $query="SELECT * FROM `images` where name='rangamati' ";
    ...
    <div class="container">
      ...
      <h2 style="text-align: center;">Rangamati View </h2>
