            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>  <?php echo $age; ?>  </td>
                        <td>
                          <a class="button" href="UpdateDelete.php?id=<?php echo $id;?>&action=edit&from=adminInfo">Edit</a>
                          <a class="button" href="UpdateDelete.php?id=<?php echo $id;?>&action=delete&from=adminInfo">Delete</a>
                        </td>
                    </tr>
                </tbody>
                <?php
